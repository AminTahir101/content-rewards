-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('CREATOR', 'BRAND', 'AGENCY', 'ADMIN');

-- CreateEnum
CREATE TYPE "OrganizationMemberRole" AS ENUM ('OWNER', 'ADMIN', 'MEMBER');

-- CreateEnum
CREATE TYPE "OrganizationType" AS ENUM ('BRAND', 'AGENCY');
...
CREATE TABLE "creator_profiles" (
    ...
    "verifiedFollowers" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "organizations" (
    ...
    "name" TEXT NOT NULL,
    "slug" TEXT NOT NULL,
    "type" "OrganizationType" NOT NULL DEFAULT 'BRAND',
    "logoUrl" TEXT,
    "website" TEXT,
    "country" TEXT DEFAULT 'SA',
    "vatNumber" TEXT,
